package com.mixware.senpaireader.services;
...
import com.mixware.senpaireader.Activities.OfflineViewer;
import com.mixware.senpaireader.Gets.getNumImagenes;
import com.mixware.senpaireader.Gets.getPagina;
...
public class DownloadService extends Service {
    ...
    private final class ServiceHandler extends Handler {
        ...
        public void doFinish() {
            ...
            mIntent.putExtra("capitulo",new File(path));
